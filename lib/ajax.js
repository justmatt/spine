...
Ajax = {
  getURL: function(object, options) {
    if (options && options.useResourceUrl) {
      return object && (typeof object.resourceUrl === "function" ? object.resourceUrl() : void 0) || object.resourceUrl;
    } else {
      return object && (typeof object.recordUrl === "function" ? object.recordUrl() : void 0) || object.recordUrl;
    }
  },
  enabled: true,
  pending: false,
...
Collection = (function(_super) {
  ...
  Collection.prototype.all = function(params) {
    return this.ajax(params, {
      type: 'GET',
      url: Ajax.getURL(new this.model, {
        useResourceUrl: true
      })
    }).success(this.recordsResponse).error(this.errorResponse);
  };
